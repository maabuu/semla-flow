...
nice -n 5 python evaluate_conditional_frags.py $file data/conditional_fragments/true_fragments_openbabel_h_sanitize.sdf data/conditional_fragments/reference_mols.sdf  --output ${file%.*}_combined.csv
